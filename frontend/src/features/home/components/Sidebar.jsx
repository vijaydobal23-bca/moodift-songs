...
const Sidebar = ({ activeView, setActiveView, user, navigate, favorites, setIsScanning }) => {
  return (
    <aside className="spotify-sidebar-container">
      <div className="spotify-sidebar-panel navigation-panel">
      ...
      <div className="spotify-sidebar-panel library-panel">
        <div className="library-header">
          <div className="library-title">
            <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
              <path d="M3 22a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H3zm1-2h16V4H4v16z"/>
              <path d="M8 8h8v2H8V8zm0 4h8v2H8v-2zm0 4h5v2H8v-2z"/>
            </svg>

            <span>Your Library</span>
          </div>
          <button className="library-add-btn" onClick={() => setActiveView("upload")} title="Upload Song">
        ...
        <nav className="library-links">
          <div
            className={`library-item ${activeView === "favorites" ? "active" : ""}`}
            onClick={() => {
              if (!user) {
                navigate("/login");
              } else {
          ...
          >
            ...
            <div className="library-item-meta">
              ...
              <span className="type">Playlist • {favorites.length} songs</span>
            </div>
          </div>

          <div
            className={`library-item ${activeView === "upload" ? "active" : ""}`}
            onClick={() => setActiveView("upload")}
          >
            <div className="upload-square-icon">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                <path d="M19.35 10.04A7.49 7.49 0 0 0 12 4C9.11 4 6.6 5.64 5.35 8.04A5.994 5.994 0 0 0 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z" />
              </svg>
            </div>
            <div className="library-item-meta">
              <span className="name">Upload Song</span>
              <span className="type">Partner Console</span>
            </div>
          </div>
          

          <div
            className="library-item library-item--scan"
            onClick={() => setIsScanning(true)}
          >
            <div className="scan-square-icon">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H7c0-2.76 2.24-5 5-5s5 2.24 5 5c0 1.04-.42 1.99-1.07 2.75z" />
              </svg>
            </div>
            <div className="library-item-meta">
              <span className="name">Scan Mood</span>
              <span className="type">Webcam scan</span>
            </div>
          </div>
        </nav>
      </div>
